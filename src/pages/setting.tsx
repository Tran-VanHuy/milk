        ...
        <Page>
            ...
            <div className="pt-[44px]">
                ...
                <div className="bg-white p-2">
                    ...
                    <div className="text-[14px]" onClick={() => nav('list-voucher')}>Khuyến mãi (Voucher)</div>
                </div>
                <div className="p-2 text-[14px] text-gray-500">Đơn hàng</div>
                <div className="bg-white p-2">
                    <div className="text-[14px] border-b-[1px] pb-2 mb-2">Đã đặt hàng</div>
                    <div className="text-[14px] border-b-[1px] pb-2 mb-2">Đang vận chuyển</div>
